...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configcheckbox(
        'block_game/change_avatar_course',
        get_string('config_avatar_course', 'block_game'),
        '',
        0
    ));

    $settings->add(new admin_setting_configcheckbox(
        'block_game/show_info',
        get_string('config_info', 'block_game'),
        get_string('config_info_help', 'block_game'),
        1
    ));

    $settings->add(new admin_setting_configcheckbox(
        'block_game/score_activities',
    ...
    $settings->add(new admin_setting_configselect(
        'block_game/bonus_badge',
        get_string('config_bonus_badge', 'block_game'),
        '',
        -2,
        $bonusbadgeoptions
    ));
    ...
    $settings->add(new admin_setting_configcheckbox(
        'block_game/show_identity',
        get_string('config_identity', 'block_game'),
        '',
        1
    ));

    $settings->add(new admin_setting_configcheckbox(
        'block_game/show_score',
    ...
    $settings->add(new admin_setting_configselect(
        'block_game/level_number',
        get_string('config_level_number', 'block_game'),
        '',
        15,
        $leveloptions
    ));
    ...
    for ($i = 1; $i <= 15; $i++) {
        $settings->add(new admin_setting_configtext(
            'block_game/level_up' . $i,
            get_string('config_level_up' . $i, 'block_game'),
            '',
            $leveluppoints[$i],
            PARAM_INT
        ));
